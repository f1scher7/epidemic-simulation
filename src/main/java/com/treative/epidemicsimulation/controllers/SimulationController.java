...
public class SimulationController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> createSimulation(@RequestBody Simulation newSimulation) throws SimulationNameAlreadyExistsException, IncorrectInitialInfectedException, IncorrectMortalityRateException, IncorrectInfectionRateException, NullFieldException, InitialInfectedExceedsPopulationException {
    ...
    @PostMapping("/update")
    public ResponseEntity<?> updateSimulation(@RequestBody Simulation updatedSimulation) throws SimulationNameAlreadyExistsException, IncorrectInitialInfectedException, IncorrectMortalityRateException, IncorrectInfectionRateException, NullFieldException, InitialInfectedExceedsPopulationException {
        Simulation simulation = this.simulationService.updateSimulation(updatedSimulation);
        return ResponseEntity.ok().body(simulation);
    }

    @DeleteMapping("/delete-by-id/{id}")
    public ResponseEntity<?> deleteSimulationById(@PathVariable Long id) {
